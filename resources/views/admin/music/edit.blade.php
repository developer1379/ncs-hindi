                            ...
                            <div class="card-body p-4">
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="mega_link" id="mega_link"
                                        class="form-control bg-light border-0" value="{{ $music->mega_link }}"
                                ...
                                <div>
                                    ...
                                    <input type="url" name="youtube_link" id="youtube_link"
                                        class="form-control bg-light border-0" value="{{ $music->youtube_link }}"
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#musicUpdateForm').on('submit', function(e) {
                    ...
                    // MANUALLY SEND MEGA LINK AS MUSIC_FILE (Mapping for Backend)
